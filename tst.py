...
# stopwords = ["明显","既能","则","更是","而","又","与","不仅","对","旅行","让","每","为了","您","的", "了", "在", "是", "我", "有","和","，","。","我们","大家","了解","一","一下","而且","了解","这里","有着","！","？","：","中国","湖北省","共产党","台湾"]  # 添加你想移除的词  
# word_counts = {word: count for word, count in word_counts.items() if word not in stopwords}  
  
# # 生成词云  
# wc = WordCloud(  # 设置字体路径，这里假设我们使用了黑体字体  
...
# plt.show()
import os
print(os.path.dirname(os.path.abspath(__file__)).join("./assets/stopwords/cn_stopwords.txt"))